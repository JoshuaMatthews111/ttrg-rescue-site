...
import {
  ...
  Activity, ChevronDown, Image as ImageIcon,
} from "lucide-react";
...
const navByRole: Record<Role, { label: string; href: string; icon: typeof LayoutDashboard; badge?: number }[]> = {
  super_admin: [
    ...
    { label: "Applications", href: "/ttrg/admin/applications", icon: FileText, badge: 8 },
  ...
  trainer: [
    ...
    { label: "Notifications", href: "/ttrg/admin/notifications", icon: Bell, badge: 2 },
  ],
  org_partner: [
    { label: "Dashboard", href: "/ttrg/admin", icon: LayoutDashboard },
